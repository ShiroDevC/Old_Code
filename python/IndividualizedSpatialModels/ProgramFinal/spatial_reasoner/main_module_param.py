...
from spatial_reasoner import model_construction_param as construct

from spatial_reasoner import low_level_functions_param as helper

from spatial_reasoner import verification_answer_param as ver_ans
...
def main():
    ...
    #["lime tree", "West", "apricot tree"], ["apricot tree", "West", "plum tree"],
    """
    helper.print_models([{(0, 0, 0) : "A", (1, 0, 0) : "B", (2, 0, 0) : "C"}])
